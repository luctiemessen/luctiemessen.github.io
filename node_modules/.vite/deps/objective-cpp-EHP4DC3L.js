...
// node_modules/shikiji/dist/langs/objective-cpp.mjs
...
x[a-fA-F0-9]{,2} |
u[a-fA-F0-9]{,4} |
U[a-fA-F0-9]{,8} )`, "name": "constant.character.escape.objcpp" }, { "match": "\\\\.", "name": "invalid.illegal.unknown-escape.objcpp" }] }, "string_placeholder": { "patterns": [{ "match": "(?x) %\n(\\d+\\$)?						   # field (argument #)\n[#0\\- +']*						  # flags\n[,;:_]?							  # separator character (AltiVec)\n((-?\\d+)|\\*(-?\\d+\\$)?)?		  # minimum field width\n(\\.((-?\\d+)|\\*(-?\\d+\\$)?)?)?	# precision\n(hh|h|ll|l|j|t|z|q|L|vh|vl|v|hv|hl)? # length modifier\n[diouxXDOUeEfFgGaACcSspn%]		   # conversion type", "name": "constant.other.placeholder.objcpp" }, { "match": '(%)(?!"\\s*(PRI|SCN))', "captures": { "1": { "name": "invalid.illegal.placeholder.objcpp" } } }] } }, "displayName": "Objective-C++" });
var objectiveCpp = [
  lang
];
export {
  objectiveCpp as default
};
//# sourceMappingURL=objective-cpp-EHP4DC3L.js.map
